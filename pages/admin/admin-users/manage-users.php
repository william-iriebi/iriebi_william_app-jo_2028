...
<body>
    ...
    <main>
        ...
        try {
            ...
            $query = "SELECT * FROM administrateur ORDER BY nom_admin";
            ...
            if ($statement->rowCount() > 0) {
                ...
                while ($row = $statement->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<td><button class='btn btn-outline-primary'onclick='openModifyUserForm({$row['id_admin']})'>Modifier</button></td>";
                    echo "<td><button class='btn btn-outline-danger' onclick='deleteUserConfirmation({$row['id_admin']})'>Supprimer</button></td>";
                    echo "</tr>";
                }
    ...
    <script>
        ...
        function openModifyUserForm(id_admin) {
            window.location.href = 'modify-user.php?id_admin=' + id_admin;
        }

        function deleteUserConfirmation(id_admin) {
            if (confirm("Êtes-vous sûr de vouloir supprimer cet utilisateur?")) {
                window.location.href = 'delete-user.php?id_admin=' + id_admin;
            }
        }
    </script>
</body>
